...
router.get('/:id', async (req, res) => {
    try {
        // populate author object in Book with info related to author id
...
router.put('/:id', async (req,res) => {
    ...
    try {
        ...
        if (req.body.cover != null && req.body.cover !== '') { // defaults empty cover on edit request. don't change cover if user doesn't edit this.
            saveCover(book, req.body.cover);
        }
        await book.save();
